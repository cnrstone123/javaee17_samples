...
public class ReceivedDatas {
	...
	private ArrayList<ReceivedData> list;
	
	public ReceivedDatas(){
		if(list == null){
			list = new ArrayList<ReceivedData>();
		}
	}
	...
	public void add(ReceivedData receiveData){
		list.add(receiveData);
	}

	public ArrayList<ReceivedData> getReceiveDatas(){
		return (ArrayList<ReceivedData>)list;
	}
	 ...
	 **/
	public ArrayList<ReceivedData> getReceiveDatas(int order){
		return (ArrayList<ReceivedData>)list;
	}
	/**
	 * added by leeys, at 2018.03.31.SAT
	 */
	public String getJSONPdata(){
		return "";
	}
	public String getJSONPDataModel(){
		return "";
	}
}
